...
create table `cms_member_report`(
 ...
 `report_type` int(1) default null commnet `举报类型：0：商品评价，1：话题内容，2：用户评论`,
 `report_member_name` varchar(128) DEFAULT null comment `举报人`,
 `create_time` datetime default null,
 `report_object` varchar(128) default null,
...
create table `cms_prefrence_area`(
 ...
 `pic` varbinary(512) default null commet `展示图片`,
 `sort` int(11) default null,
 `show_status` int(1) default null,
 primary key (`id`)
